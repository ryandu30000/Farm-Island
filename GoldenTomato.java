...
public class GoldenTomato extends Plant
{
    ...
    /**
     * Initializes a Golden Tomato plant with the default yield and sell price.
     */
    public GoldenTomato(){
        super(Y_OFFSET);
    ...
    /**
     * Initializes a Golden Tomato plant with a specified yield.
     * 
     * @param yield The yield of the GoTomato plant.
     */
    ...
    /**
     * Performs the act of the Golden Tomato plant.
     */
    public void act()
    {
        super.act();
    ...
    /**
     * Initializes the Golden Tomato plant with growth animations.
     */
    ...
    /**
     * Simulates the growth of the Golden Tomato plant.
     */
    public void grow(){
        maturity += growthRate;
    ...
    /**
     * Advances to the next frame of the Golden Tomato plant's growth animation.
     */
    ...
    /**
     * Checks for keypress actions related to the Golden Tomato plant.
     */
    ...
    /**
     * Plays the sound when placing the Golden Tomato plant.
     */
    ...
    /**
     * Plays the sound when removing the Golden Tomato plant.
     */
